...
const sidebarNavItems: NavItem[] = [
    {
        title: 'Data Lokasi Wisata',
        href: '/admin/lokasiwisata',
    },
    {
        title: 'Form Lokasi Wisata',
        href: '/admin/lokasiwisata/create',
        match: ['/admin/lokasiwisata/create', '/admin/lokasiwisata/*'],
    },
];
...
<template>
    <div class="px-4 py-6">
        <Heading title="Lokasi Wisata" description="Kelola data lokasi wisata" />
